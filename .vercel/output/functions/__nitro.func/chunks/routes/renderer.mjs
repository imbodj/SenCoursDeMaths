...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Petit site contenant une flopée de ressources pour les mathématiques au secondaire : plans, développements, bibliographie, ..."},{"name":"theme-color","content":"#343a40"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"titleTemplate":"%s | SenCoursDeMaths","htmlAttrs":{"lang":"fr"}};
