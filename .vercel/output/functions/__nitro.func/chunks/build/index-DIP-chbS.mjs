...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: lessons, status, error } = ([__temp, __restore] = withAsyncContext(() => useFetch("/_api/latex/lecons/", "$k8vS2uGK7S")), __temp = await __temp, __restore(), __temp);
    const route = useRoute();
    const path = removeTrailingSlashIfPossible(route.path);
    usePdfBanner(`/pdf${path}.pdf`);
    usePageHead({ title: "Liste des le\xE7ons" });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(status) === "pending") {
        ...
        _push(`</div>`);
      } else if (unref(lessons)) {
        _push(`<div${ssrRenderAttrs(_attrs)}><h1>Liste des le\xE7ons</h1>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/lecons/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-DIP-chbS.mjs.map
