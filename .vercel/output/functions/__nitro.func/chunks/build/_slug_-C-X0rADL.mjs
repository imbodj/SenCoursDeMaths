...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: sheet, status, error } = ([__temp, __restore] = withAsyncContext(() => useFetch(`/_api/latex/fiches/${route.params.slug}.json`, "$lxWUtbPKca")), __temp = await __temp, __restore(), __temp);
      ...
      if (unref(status) === "pending") {
        ...
        _push(ssrRenderComponent(_component_Title, null, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(unref(sheet)["page-title"])}`);
            } else {
              return [
                createTextVNode(toDisplayString(unref(sheet)["page-title"]), 1)
              ];
            }
          }),
          _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/fiches/[slug].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_slug_-C-X0rADL.mjs.map
