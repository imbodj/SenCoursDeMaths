...
import { _ as _sfc_main$1 } from './DevelopmentCard-C6CuXv1N.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: developments, status, error } = ([__temp, __restore] = withAsyncContext(() => useFetch("/_api/latex/developpements/", "$0UN5Kxo0vU")), __temp = await __temp, __restore(), __temp);
    const route = useRoute();
    const path = removeTrailingSlashIfPossible(route.path);
    usePdfBanner(`/pdf${path}.pdf`);
    usePageHead({ title: "Liste des d\xE9veloppements" });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(status) === "pending") {
        ...
        _push(`</div>`);
      } else if (unref(developments)) {
        _push(`<div><h1>Liste des d\xE9veloppements</h1>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/developpements/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-CZ_g2fw5.mjs.map
