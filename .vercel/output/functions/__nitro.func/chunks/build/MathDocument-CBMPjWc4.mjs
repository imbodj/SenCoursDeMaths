  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        ref: root,
        class: "math-document"
      }, _attrs))} data-v-ea3ac75d>${(_a = _ctx.body) != null ? _a : ""}</div>`);
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/MathDocument.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ea3ac75d"]]);

export { Meta as M, Title as T, __nuxt_component_2 as _ };
//# sourceMappingURL=MathDocument-CBMPjWc4.mjs.map
