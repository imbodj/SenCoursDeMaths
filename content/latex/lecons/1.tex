...
\hline
Si $ \bullet\; \displaystyle \lim_{x \to a^+} \frac{f(x)-f(a)}{x-a} = +\infty$, la courbe de $f$ admet au point $A(a, f(a))$ une demi-tangente verticale dirigée vers le haut. 
&
...
\hline
\text{\(I = [a,b]\)} & [f(a), f(b)] & [f(b), f(a)] \\
\hline
\text{\(I = [a,b[\)} & \left[ f(a), \lim\limits_{x \to b^-} f(x) \right[ & \left] \lim\limits_{x \to b^-} f(x), f(a) \right] \\
\hline
\text{\(I = ]a,b]\)} & \left] \lim\limits_{x \to a^+} f(x), f(b) \right] & \left[ f(b), \lim\limits_{x \to a^+} f(x) \right[ \\
\hline
\text{\(I = ]a,b[\)} & \left] \lim\limits_{x \to a^+} f(x), \lim\limits_{x \to b^-} f(x) \right[ & \left] \lim\limits_{x \to b^-} f(x), \lim\limits_{x \to a^+} f(x) \right[ \\
\hline
\end{array}
$$
