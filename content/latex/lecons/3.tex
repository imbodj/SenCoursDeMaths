...
% Bissectrice y = x
\draw[domain=-1:5] plot (\x, \x);

% Courbe f(x) = sqrt(3x + 4) en rouge
\draw[domain=-1.3:5, red, samples=150] plot (\x, {sqrt(3*\x + 4)});

% Labels des courbes
\node[above right] at (5,5) {$y = x$};
\node[above right] at (5,4) {$\mathscr{C}_{f}$};
\node[below left] at (0,0) {O};

% Labels des points sur les axes
\node[below left] at (-1,0) {$u_{0}$};
\node[below right] at (1,0) {$u_{1}$};
\node[above right] at (0,1) {$u_{1}$};
\node[left] at (0,2.645) {$u_{2}$};
\node[below] at (2.645,0) {$u_{2}$};
\node[left] at (0,3.454) {$u_{3}$};
\node[below] at (3.454,0) {$u_{3}$};
\node[left] at (0,3.789) {$u_{4}$};
\node[below] at (3.789,0) {$u_{4}$};

% Vecteurs de base
\node[below] at (0.5,0) {$\overrightarrow{i}$};
\node[left] at (0,0.5) {$\overrightarrow{j}$};

% Lignes pointillées horizontales et verticales
\draw[dotted] (0,2.645) -- (1,2.645);
\draw[dotted] (2.645,0) -- (2.645,2.645);
\draw[dotted] (-1,0) -- (-1,1);
\draw[dotted] (1,0) -- (1,1);
\draw[dotted] (2.645,3.454) -- (0,3.454);
\draw[dotted] (3.454,3.454) -- (3.454,0);
\draw[dotted] (3.789,3.789) -- (0,3.789);
\draw[dotted] (3.789,3.789) -- (3.789,0);

% Lignes en tirets pour la construction de la suite
\draw[dashed] (-1,1) -- (1,1);
\draw[dashed] (1,1) -- (1,2.645);
\draw[dashed] (1,2.645) -- (2.645,2.645);
\draw[dashed] (2.645,2.645) -- (2.645,3.454);
\draw[dashed] (2.645,3.454) -- (3.454,3.454);
\draw[dashed] (3.454,3.454) -- (3.454,3.789);
\draw[dashed] (3.454,3.789) -- (3.789,3.789);
\draw[dashed] (3.789,3.789) -- (3.789,3.92);
\draw[dashed] (3.789,3.92) -- (3.92,3.92);
