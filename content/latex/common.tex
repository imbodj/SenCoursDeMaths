...
\usepackage{tkz-tab}  % Package nécessaire pour \tkzTab
\usepackage{fontspec}
...
\usepackage{mathrsfs}   % Police de maths joli caligraphie :
			    % $\mathscr{P}$ pour un plan par exemple
...
\newcommand{\inte}[4]{\displaystyle\int_{#1}^{#2}#3{\rm d}#4}
...
\newcommand{\change}{\rule{\textwidth}{1mm}\\}
...
\fancyfoot[C]{\scriptsize \href{\website}{\texttt{\website}}}
...
\definecolor{methode}{HTML}{607d8b}
\definecolor{proof}{HTML}{e1f5fe}
\definecolor{exercice}{HTML}{e1f5fe}


% Style de théorème personnalisé avec saut de ligne
